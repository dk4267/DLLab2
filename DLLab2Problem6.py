...
#function to create LSTM model from problem 5
def createModel():
    model = Sequential()
...
#grid search to find the optimal batch size and number of epochs
...
#create and fit model, print accuracy and loss scores
#model = createModel()
